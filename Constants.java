...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final int LEFT_LEADER_ID = 1; //1;
    public static final int LEFT_FOLLOWER_ID = 2; //2;
    public static final int RIGHT_LEADER_ID = 3; //3;
    public static final int RIGHT_FOLLOWER_ID = 4; //4;
  ...
  public static final class OperatorConstants {
    ...
    public static final double ROTATION_SCALING = .3;
  }
}
